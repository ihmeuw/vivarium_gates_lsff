...
``src/vivarium_gates_lsff/model_specifications``.
Add location strings to the ``src/vivarium_gates_lsff/constants/metadata.py``
...
`src/vivarium_gates_lsff/constants/metadata.py``.
...
from vivarium_gates_lsff.tools import (build_artifacts,
...
def make_specs(template: str, location: str, output_dir: str, verbose: int, with_debugger: bool) -> None:
    ...
    ``src/vivarium_gates_lsff/model_specification/model_spec.in``
    """
